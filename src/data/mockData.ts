...
export const mockBlogs: Blog[] = [
  {
    ...
    coverImage: 'https://clipground.com/images/solid-background-color-in-clipart-9.jpg',
    category: 'trends',
    status: 'published',
  ...
  },
  {
    ...
    coverImage: 'https://cdn.wallpapersafari.com/24/63/rOWPU3.jpg',
    category: 'reviews',
    status: 'published',
  ...
  },
  {
    ...
    coverImage: 'https://images.hdqwalls.com/wallpapers/soft-gradient-solid-color-4k-yl.jpg',
    category: 'tips',
    status: 'draft',
